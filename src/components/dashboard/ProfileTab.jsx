...
export default function ProfileTab() {
    ...
    return (
        <div className="animate-fade-in" style={{ maxWidth: '640px' }}>
            ...
            <div className="card p-6 mb-6" style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
                <div style={{
                ...
                <div>
                    ...
                    <p style={{ color: 'var(--color-text-muted)', fontSize: '0.9rem', marginTop: '4px', display: 'flex', alignItems: 'center', gap: '6px' }}>
            ...
            <div className="card p-6 mb-6">
                ...
                <form onSubmit={handleNameSave} className="flex-col gap-4">
                    <div>
            ...
            <div className="card p-6">
                ...
                {isGoogleUser ? (
                    ...
                    <form onSubmit={handlePasswordSave} className="flex-col gap-4">
                        <div>
